...
export const getSampleProducts = () => {
  const products = [
    ...
    // Product 3 - Cordless Robotic Pool Cleaner
    {
      ...
      slug: 'cordless-robotic-pool-cleaner-150-mins-runtime-ipx8-waterproof-2200-sq-ft-coverage-powerful-automati',
    ...
    // Product 4 - WYBOT C2 Vision Cordless Pool Cleaner
    {
      ...
      slug: 'wybot-c2-vision-cordless-pool-cleaner-with-camera-8-in-1-pool-vacuum-for-inground-pools-powerful-suc',
    ...
    // Product 7 - Ringke Rugged Gear iPhone 16 Pro Max Case
    {
      ...
      slug: 'ringke-rugged-gear-oil-dirt-resistant-compatible-with-iphone-16-pro-max-case-prevents-oily-smudges-n',
    ...
    // Product 8 - Kasa Indoor Pan/Tilt Smart Security Camera
    {
      ...
      slug: 'kasa-indoor-pantilt-smart-security-camera-1080p-hd-dog-camera24ghz-with-night-visionmotion-detection',
    ...
    // Product 9 - Furhaven Waterproof Throw Blanket for Dogs
    {
      ...
      slug: 'furhaven-waterproof-throw-blanket-for-dogs-indoor-cats-washable-shaggy-plush-calming-long-faux-fur-v',
    ...
    // Product 10 - EHEYCIGA Orthopedic Dog Beds
    {
      ...
      slug: 'eheyciga-orthopedic-dog-beds-large-sized-dog-waterproof-memory-foam-pet-bed-with-sides-non-slip-bott',
    ...
    // Product 11 - IRIS USA Dog Food Storage Container
    {
      ...
      slug: 'iris-usa-dog-food-storage-container-30-lbs-11-lbs-combo-cat-food-storage-container-dog-treat-contain',
    ...
    // Product 12 - Veken Innovation Award Winner Pet Fountain
    {
      ...
      slug: 'veken-innovation-award-winner-95oz28l-pet-fountain-automatic-cat-water-fountain-dog-water-dispenser',
    ...
    // Product 13 - Always Full Pet Water Bowl and Bottle Pump Bundle
    {
      ...
      slug: 'always-full-9-pet-water-bowl-and-bottle-pump-bundle-self-refilling-clean-filtered-water-app-enabled',
    ...
    // Product 14 - KENNELS & KATS Pet Grooming Gloves
    {
      ...
      slug: 'kennels-kats-pet-grooming-gloves-deshedding-glove-for-easy-mess-free-grooming-grooming-mitt-for-dogs',
    ...
    // Product 16 - KEYHELP Pet Hair Removal Glove
    {
      ...
      slug: 'keyhelp-pet-hair-removal-glove-for-dogs-cats-newly-upgraded-reusable-electrostatic-pet-hair-gloves-p',
    ...
    // Product 17 - IRIS USA Stackable Dog Food Storage Container
    {
      ...
      slug: 'iris-usa-stackable-dog-food-storage-container-with-2-cup-scoop-4-secure-latches-fits-up-to-30-lbs-pe',
    ...
    // Product 18 - PetSafe ScoopFree Disposable Crystal Cat Litter Tray
    {
      ...
      slug: 'petsafe-scoopfree-disposable-crystal-cat-litter-tray-easy-cleaning-box-refill-tray-for-electric-litt',
    ...
    // Product 19 - Best Pet Supplies Interactive Squeaky Dog Chew Toy
    {
      ...
      slug: 'best-pet-supplies-interactive-squeaky-dog-chew-toy-ideal-dog-toys-for-chewers-small-medium-large-dog',
    ...
    // Product 20 - URPOWER Dog Car Seat Cover
    {
      ...
      slug: 'urpower-dog-car-seat-cover-for-pets-100-waterproof-seat-cover-hammock-600d-heavy-duty-scratch-proof',
    ...
    // Product 21 - PetLab Co. Probiotics for Dogs
    {
      ...
      slug: 'petlab-co-probiotics-for-dogs-support-gut-health-occasional-diarrhea-digestive-health-seasonal-aller',
    ...
    // Product 22 - Pet Honesty Probiotics for Dogs
    {
      ...
      slug: 'pet-honesty-probiotics-for-dogs-for-occasional-diarrhea-bowel-support-digestive-enzymes-with-prebiot',
    ...
    // Product 25 - Ameritex Pet Bed Blanket Reversible
    {
      ...
      slug: 'ameritex-pet-bed-blanket-reversible-100-waterproof-velvet-super-soft-for-sofa-and-bed-52x82-inches-l',
    ...
    // Product 26 - Dog Grooming Kit & Dog Hair Vacuum
    {
      ...
      slug: 'dog-grooming-kit-dog-hair-vacuum15000-pa-powerful-suction-pet-grooming-vacuum-removes-99-pet-hair-in',
    ...
    // Product 27 - FurMe ULTRA Pet Grooming Vacuum Kit
    {
      ...
      slug: 'furme-ultra-pet-grooming-vacuum-kit-cat-dog-grooming-kit-for-easy-pet-care-at-home-quiet-safe-dog-ha',
    ...
    // Product 28 - FurMe Original Pet Grooming Vacuum Kit
    {
      ...
      slug: 'furme-original-pet-grooming-vacuum-kit-cat-dog-grooming-kit-for-easy-pet-care-at-home-quiet-safe-dog',
    ...
    // Product 29 - Uproot Clean Pet Groomer Vacuum Kit
    {
      ...
      slug: 'uproot-clean-pet-groomer-vacuum-kit-7-in-1-cat-dog-grooming-kit-with-brush-detangle-deshed-trim-clea',
    ...
    // Product 30 - oneisall Dog Clipper Low Noise
    {
      ...
      slug: 'oneisall-dog-clipper-low-noise-dog-grooming-kit-with-rechargeable-pet-shaver-cordless-electric-quiet',
    ...
    // Product 31 - Checkered Makeup Bag
    {
      ...
      slug: 'checkered-makeup-bag-portable-makeup-bag-with-adjustable-partition-cosmetic-bags-for-women-toiletry',
    ...
    // Product 32 - Makeup Bag 2 Pack
    {
      ...
      slug: 'makeup-bag-cosmetic-bag-portable-leather-large-checkered-makeup-bag-2-pack-large-capacity-travel-cos',
    ...
    // Product 33 - LIBIHUA Future Mrs Makeup Bag
    {
      ...
      slug: 'libihua-future-mrsfunny-engagement-gift-for-bride-makeup-bag-cosmetic-bag-travel-pouchbride-to-be-ne',
    ...
    // Product 34 - Gifts for Her Initial Makeup Bags
    {
      ...
      slug: 'gifts-for-her-initial-large-makeup-bags-personalized-double-layer-cosmetic-bags-with-makeup-brush-or',
    ...
    // Product 35 - Birthday Gifts Makeup Organizer Bag Set
    {
      ...
      slug: 'birthday-gifts-for-women-teen-girl-personalized-initial-makeup-organizer-bag-set-open-flat-travel-co',
    ...
    // Product 37 - Micoson Women's Long Sleeve Tops
    {
      ...
      slug: 'micoson-womens-long-sleeve-tops-dressy-casual-fall-clothes-fashion-2025-v-neck-clothing-color-block',
    ...
    // Product 40 - Logitech G502 HERO Gaming Mouse
    {
      ...
      slug: 'logitech-g502-hero-high-performance-wired-gaming-mouse-hero-25k-sensor-25600-dpi-rgb-adjustable-weig',
    ...
    // Product 52 - sqlp Large Work Tote Bag
    {
      ...
      slug: 'sqlp-large-work-tote-bag-for-women-designer-purses-and-handbags-big-bucket-bags-ladies-travel-crossb',
    ...
    // Product 56 - BOYATU Travel Makeup Bag 3 Pcs Set Coffee
    {
      ...
      slug: 'boyatu-travel-makeup-bag-cosmetic-bags-for-women-3-pcs-set-large-portable-make-up-bag-with-handle-ve',
    ...
    // Product 57 - BOYATU Travel Makeup Bag 3 Pcs Set Beige
    {
      ...
      slug: 'boyatu-travel-makeup-bag-cosmetic-bags-for-women-3-pcs-set-portable-make-up-bag-with-handle-vegan-le',
    ...
    // Product 59 - Masa Kawa Leather Hanging Travel Toiletry Bag
    {
      ...
      slug: 'masa-kawa-leather-hanging-travel-toiletry-bag-for-men-portable-expandable-camping-cosmetics-makeup-t',
    ...
    // Product 60 - Genuine Leather Toiletry Bag
    {
      ...
      slug: 'genuine-leather-toiletry-bag-for-men-women-large-waterproof-travel-dopp-kit-handmade-shaving-cosmeti',
    ...
    // Product 61 - Masa Kawa Leather Hanging Travel Toiletry Bag (Duplicate)
    {
      ...
      productNumber: 61,
      name: 'Masa Kawa Leather Hanging Travel Toiletry Bag for Men Portable Expandable Camping Cosmetics Makeup Toiletries Organizer Waterproof Bathroom Shaving Kit Black Wash Bags',
      slug: 'masa-kawa-leather-hanging-travel-toiletry-bag-for-men-portable-expandable-camping-cosmetics-61',
      description: 'Leather hanging toiletry bag for men with expandable design and waterproof protection.',
      price: 38,
      originalPrice: 38,
      category: 'beauty',
    ...
    // Product 64 - Nolita Handmade Genuine Buffalo Leather Toiletry Bag
    {
      ...
      slug: 'nolita-handmade-genuine-buffalo-leather-hanging-toiletry-bag-travel-dopp-kit-for-men-and-women-crazy',
    ...
    // Product 65 - Stroller Rain Cover
    {
      ...
      slug: 'stroller-rain-coveruniversal-rain-cover-for-side-by-side-baby-stroller-double-stroller-cover-for-rai',
    ...
    // Product 68 - Leeleberd Led Lights for Bedroom
    {
      ...
      slug: 'leeleberd-led-lights-for-bedroom-100-ft-2-rolls-of-50ft-music-sync-color-changing-rgb-led-strip-ligh',
    ...
    // Product 69 - My First Library: Boxset of 10 Board Books
    {
      ...
      slug: 'my-first-library-boxset-of-10-board-books-for-kids-board-book-april-25-2018-by-wonder-house-books-au',
    ...
    // Product 70 - HelloBaby No WiFi Baby Monitor
    {
      ...
      slug: 'hellobaby-no-wifi-baby-monitor-5-screen-30-hour-battery-pan-tilt-zoom-video-upgrade-with-camera-and',
    ...
    // Product 71 - Babystar Baby Monitor with Camera and Audio
    {
      ...
      slug: 'babystar-baby-monitor-with-camera-and-audio-720p-hd-resolution-5-display-up-to-22-hour-battery-remot',
    ...
    // Product 73 - GROWNSY Baby Food Maker
    {
      ...
      slug: 'grownsy-baby-food-maker-with-steam-basket-one-step-baby-food-processor-steamer-puree-blender-grinder',
    ...
    // Product 74 - GROWNSY Baby Food Maker Dark Grey
    {
      ...
      slug: 'grownsy-baby-food-maker-with-steam-basket-one-step-baby-food-processor-steamer-puree-blender-74',
    ...
    // Product 75 - Huggies Size 3 Overnites Baby Diapers
    {
      ...
      slug: 'huggies-size-3-overnites-baby-diapers-overnight-diapers-size-3-16-28-lbs-132-ct-2-packs-of-66-packag',
    ...
    // Product 76 - Hostinger Web Hosting
    {
      ...
      slug: 'hostinger-is-a-web-hosting-service-provider-that-offers-domain-registration-email-hosting-and-a-rang',
    ...
    // Product 78 - Brother CS7000X Sewing and Quilting Machine
    {
      ...
      slug: 'brother-cs7000x-computerized-sewing-and-quilting-machine-70-built-in-stitches-lcd-display-wide-table',
    ...
    // Product 79 - HP 15.6 inch Laptop
    {
      ...
      slug: 'hp-156-inch-laptop-hd-touchscreen-display-amd-ryzen-3-7320u-8-gb-ram-256-gb-ssd-amd-radeon-graphics',
    ...
    // Product 80 - HP 17.3 inch Laptop
    {
      ...
      slug: 'hp-173-inch-laptop-hd-display-amd-ryzen-5-7520u-16-gb-ram-512-gb-ssd-amd-radeon-graphics-windows-11',
    ...
    // Product 81 - HP 17.3" Laptop Computer with Intel i3
    {
      ...
      slug: 'hp-173-laptop-computer-intel-13th-8-cores-i3-cpu-beat-11th-i5-32gb-ram-1tb-ssd-10-key-number-pad-win',
    ...
    // Product 82 - Tapo TP-Link ColorPro Wi-Fi Outdoor Camera
    {
      ...
      slug: 'tapo-tp-link-colorpro-wi-fi-outdoor-camera-plug-in-daylight-clarity-at-night-2k-qhd-personpetvehicle',
    ...
    // Product 83 - Tapo by TP-Link Smart Video Doorbell Camera
    {
      ...
      slug: 'tapo-by-tp-link-smart-video-doorbell-camera-wireless-with-chime-2k-with-full-color-night-vision-spot',
    ...
    // Product 84 - MacBook Charger
    {
      ...
      slug: 'charger-for-macbook-pro-16-14-inch-macbook-air-15-13-inch-2025-2024-2023-2022-2021-2020-2019-m4-m3-m',
    ...
    // Product 85 - Amazon Basics 68W GaN Charger
    {
      ...
      slug: 'amazon-basics-68w-two-port-gan-wall-charger-with-2-usb-c-ports-60w-18w-with-pd-for-laptops-tablets-p',
    ...
    // Product 86 - Mac AC Wall Adapter Plug Duckhead
    {
      ...
      slug: 'mac-ac-wall-adapter-plug-duckhead-us-wall-charger-ac-cord-us-standard-duck-head-for-macbook-mac-iboo',
    ...
    // Product 88 - Coolby 15.6inch Laptop
    {
      ...
      slug: 'coolby-156inch-laptop-12gb-ram256gb-ssd-1920x1080-ips-display-intel-n95beats-n5095-quad-core-laptop',
    ...
    // Product 89 - AE86 15.6" Laptop
    {
      ...
      slug: 'ae86-156-laptop-celeron-n4000-12gb-ram-256gb-ssd-full-hd-1080p-display-dual-band-wifi-mini-hdmi-ligh',
    ...
    // Product 90 - MacBook Air 13.6 inch Case
    {
      ...
      slug: 'compatible-for-macbook-air-136-inch-case-m4-m3-m2-2025-2024-2022-release-model-a3240-a3113-a2681-stu',
    ...
    // Product 91 - SUPCASE MacBook Air 13 Inch Case
    {
      ...
      slug: 'supcase-for-macbook-air-13-inch-case-2025-2022-unicorn-beetle-m4-a3240-m3-a3113-m2-a2681-heavy-duty',
    ...
    // Product 92 - CISSOOK MacBook Air 13.6 Inch Astronaut Case
    {
      ...
      slug: 'cissook-case-compatible-with-macbook-air-136-inch-2022-2024-2025-release-model-a2681-m2-a3113-m3-a32',
    ...
    // Product 93 - MacBook Air 13.6 inch Case (Generic)
    {
      ...
      slug: 'compatible-for-macbook-air-136-inch-case-m4-m3-m2-2025-2024-2022-release-model-a3240-a3113-a2681-93',
    ...
    // Product 94 - F FORITO Magnetic Privacy Screen Protector
    {
      ...
      slug: 'f-forito-magnetic-privacy-screen-protector-compatible-with-macbook-air-136-inch-2022-2025-m2-m3-m4-3',
    ...
    // Product 1 - HP 14 Laptop
    {
      ...
      slug: 'hp-14-laptop-intel-celeron-n4020-4-gb-ram-64-gb-storage-14-inch-micro-edge-hd-display-windows-11-hom',
    ...
    // Product 2 - Lenovo V15 Gen 4 Business Laptop
    {
      ...
      slug: 'lenovo-v15-gen-4-business-laptop-156-fhd-display-intel-core-i5-13420h-beat-i7-1355u-hdmi-rj45-webcam',
    ...
    // Product 3 - Lenovo V-Series V15 Business Laptop
    {
      ...
      slug: 'lenovo-v-series-v15-business-laptop-156-fhd-display-amd-ryzen-7-7730u-40gb-ram-2tb-ssd-numeric-keypa',
    ...
    // Product 4 - Lenovo IdeaPad 5X 2-in-1
    {
      ...
      slug: 'lenovo-ideapad-5x-2-in-1-copilot-extra-long-battery-life-14-wuxga-fhd-oled-touch-display-16gb-memory',
    ...
    // Product 5 - Lenovo LOQ 15 Gaming Laptop
    {
      ...
      slug: 'lenovo-loq-15-nvidia-geforce-rtx-5050-graphics-156-ips-lcd-fhd-144hz-display-intel-core-i7-13650hx-2',
    ...
    // Product 6 - LG gram Pro 17-inch
    {
      ...
      slug: 'lg-gram-pro-17-inch-lightweight-laptop-computer-intel-evo-edition-powered-by-intel-core-ultra9-285h',
    ...
    // Product 7 - LG gram Pro 16-inch
    {
      ...
      slug: 'lg-gram-pro-16-inch-lightweight-laptop-computer-intel-evo-edition-powered-by-intel-core-ultra7-258v',
    ...
    // Product 8 - Lenovo IdeaPad 5X 2-in-1 (Duplicate with different price)
    {
      ...
      productNumber: 8,
      name: 'Lenovo IdeaPad 5X 2-in-1 Copilot+ Extra-Long Battery Life 14" WUXGA FHD+ OLED Touch Display 16GB Memory 512GB Storage Snapdragon X Plus 8-core Processor Windows 11 Home, Pen Included, Luna Gray',
      slug: 'lenovo-ideapad-5x-2-in-1-copilot-extra-long-battery-life-14-wuxga-fhd-oled-lenovo-ideapad-5x-alt',
      description: 'Versatile 2-in-1 laptop with Snapdragon X Plus processor, 16GB RAM, 512GB storage, 14" WUXGA FHD+ OLED touch display, and extra-long battery life. Includes pen and Windows 11 Home.',
      price: 821,
      originalPrice: 821,
      category: 'electronics',
    ...
    // Product 9 - Bicycle Pump with Gauge
    {
      ...
      slug: 'bicycle-pump-with-gauge-3x-faster-auto-stop-brushless-motor-electric-bike-tire-pump-with-presta-and',
    ...
    // Product 10 - VOCH GALA Nipple Covers
    {
      ...
      slug: 'voch-gala-nipple-covers-2-pairs-seamless-and-sheer-adhesive-silicone-nipple-pasties-for-women-reusab',
    ...
    // Product 11 - Popular Girls Padded Training Bra
    {
      ...
      slug: 'popular-girls-padded-training-bra-pack-crop-cami-training-bras-for-girls-seamless-bra-design-with-re',
    ...
    // Product 12 - Popular Cotton Girls Training Bra
    {
      ...
      slug: 'popular-cotton-girls-training-bra-crop-cami-training-bras-for-girls-with-adjustable-straps-cotton-br',
    ...
    // Product 13 - Hilarious Jokes For 8 Year Old Kids
    {
      ...
      slug: 'hilarious-jokes-for-8-year-old-kids-an-awesome-lol-gag-book-for-young-boys-and-girls-filled-with-ton',
    ...
    // Product 15 - Popular Cotton Girls Training Bra (Alternative)
    {
      ...
      productNumber: 15,
      name: 'Popular Cotton Girls Training Bra - Crop Cami Training Bras for Girls with Adjustable Straps. Cotton Bra Pack.',
      slug: 'popular-cotton-girls-training-bra-crop-cami-training-bras-for-girls-girls-cotton-training-bra-alt',
      description: 'Cotton training bra for girls with adjustable straps. Crop cami style training bras made from comfortable cotton material.',
      price: 16.98,
      originalPrice: 16.98,
      category: 'fashion',
    ...
    // Product 16 - Popular Womens Bike Shorts
    {
      ...
      slug: 'popular-womens-bike-shorts-plus-size-cotton-biker-bottoms-bermuda-long-shorts-for-women-great-gym-wo',
    ...
    // Product 17 - Mouse Jiggler Mover
    {
      ...
      slug: 'mouse-jiggler-mover-wiggler-undetectable-shaker-usb-port-for-computer-laptop-keeps-pc-awake-simulate',
    ...
    // Product 18 - LISEN Retractable Car Charger
    {
      ...
      slug: 'lisen-retractable-car-charger-69w-cars-adapter-usb-c-fast-charger-car-accessories-for-women-men-chri',
    ...
    // Product 24 - 16 inch Screen Magnifier
    {
      ...
      slug: '16-inch-screen-magnifier-for-cell-phone-3d-magnifier-screen-enlarger-for-moviesvideosreadinggaming-s',
    ...
    // Product 25 - Bitzee Interactive Toy
    {
      ...
      slug: 'bitzee-interactive-toy-digital-pet-with-15-animals-inside-virtual-electronic-pets-react-to-touch-kid',
    ...
    // Product 26 - JBL Clip 4 Bluetooth Speaker
    {
      ...
      slug: 'jbl-clip-4-portable-mini-bluetooth-speaker-big-audio-and-punchy-bass-integrated-carabiner-ip67-water',
    ...
    // Product 27 - Samsung Galaxy Watch Ultra
    {
      ...
      slug: 'samsung-galaxy-watch-ultra-2024-47mm-lte-ai-smartwatch-wenergy-score-wellness-tips-heart-rate-tracki',
    ...
    // Product 1 Copy 1 - HP 14 Laptop (Image 2 as primary)
    {
      ...
      productNumber: 1,
      name: 'HP 14 Laptop, Intel Celeron N4020, 4 GB RAM, 64 GB Storage, 14-inch Micro-edge HD Display, Windows 11 Home, Thin & Portable, 4K Graphics, One Year of Microsoft 365 (14-dq0040nr, Snowflake White)',
      slug: 'hp-14-laptop-intel-celeron-n4020-4-gb-ram-64-gb-storage-14-inch-micro-edge-hd-display-windows-11-v1',
      description: 'Thin and portable HP 14 laptop with Intel Celeron N4020 processor, 4GB RAM, 64GB storage, and Windows 11 Home. Features 14-inch Micro-edge HD display and includes one year of Microsoft 365.',
      price: 171,
      originalPrice: 171,
      category: 'electronics',
    ...
    // Product 1 Copy 2 - HP 14 Laptop (Image 3 as primary)
    {
      ...
      productNumber: 1,
      name: 'HP 14 Laptop, Intel Celeron N4020, 4 GB RAM, 64 GB Storage, 14-inch Micro-edge HD Display, Windows 11 Home, Thin & Portable, 4K Graphics, One Year of Microsoft 365 (14-dq0040nr, Snowflake White)',
      slug: 'hp-14-laptop-intel-celeron-n4020-4-gb-ram-64-gb-storage-14-inch-micro-edge-hd-display-windows-11-v2',
      description: 'Thin and portable HP 14 laptop with Intel Celeron N4020 processor, 4GB RAM, 64GB storage, and Windows 11 Home. Features 14-inch Micro-edge HD display and includes one year of Microsoft 365.',
      price: 171,
      originalPrice: 171,
      category: 'electronics',
    ...
    // Product 2 Copy 1 - Lenovo V15 Gen 4 (Image 2 as primary)
    {
      ...
      productNumber: 2,
      name: 'Lenovo V15 Gen 4 Business Laptop, 15.6" FHD Display, Intel Core i5-13420H (Beat i7-1355U), HDMI, RJ45, Webcam, Numeric Keypad, Wi-Fi, Windows 11 Pro, Black (16GB RAM | 512GB SSD)',
      slug: 'lenovo-v15-gen-4-business-laptop-156-fhd-display-intel-core-i5-13420h-beat-i7-1355u-hdmi-rj45-v1',
      description: 'Professional business laptop with Intel Core i5-13420H processor, 16GB RAM, 512GB SSD, 15.6" FHD display, and Windows 11 Pro. Features HDMI, RJ45, webcam, and numeric keypad.',
      price: 529,
      originalPrice: 529,
      category: 'electronics',
    ...
    // Product 2 Copy 2 - Lenovo V15 Gen 4 (Image 3 as primary)
    {
      ...
      productNumber: 2,
      name: 'Lenovo V15 Gen 4 Business Laptop, 15.6" FHD Display, Intel Core i5-13420H (Beat i7-1355U), HDMI, RJ45, Webcam, Numeric Keypad, Wi-Fi, Windows 11 Pro, Black (16GB RAM | 512GB SSD)',
      slug: 'lenovo-v15-gen-4-business-laptop-156-fhd-display-intel-core-i5-13420h-beat-i7-1355u-hdmi-rj45-v2',
      description: 'Professional business laptop with Intel Core i5-13420H processor, 16GB RAM, 512GB SSD, 15.6" FHD display, and Windows 11 Pro. Features HDMI, RJ45, webcam, and numeric keypad.',
      price: 529,
      originalPrice: 529,
      category: 'electronics',
    ...
    // Product 3 Copy 1 - Lenovo V-Series V15 AMD (Image 2 as primary)
    {
      ...
      productNumber: 3,
      name: 'Lenovo V-Series V15 Business Laptop, 15.6" FHD Display, AMD Ryzen 7 7730U, 40GB RAM, 2TB SSD, Numeric Keypad, HDMI, RJ45, Webcam, Wi-Fi, Windows 11 Pro, Black',
      slug: 'lenovo-v-series-v15-business-laptop-156-fhd-display-amd-ryzen-7-7730u-40gb-ram-2tb-ssd-numeric-v1',
      description: 'High-performance business laptop with AMD Ryzen 7 7730U processor, 40GB RAM, 2TB SSD, 15.6" FHD display, and Windows 11 Pro. Perfect for demanding business applications.',
      price: 648,
      originalPrice: 648,
      category: 'electronics',
    ...
    // Product 3 Copy 2 - Lenovo V-Series V15 AMD (Image 3 as primary)
    {
      ...
      productNumber: 3,
      name: 'Lenovo V-Series V15 Business Laptop, 15.6" FHD Display, AMD Ryzen 7 7730U, 40GB RAM, 2TB SSD, Numeric Keypad, HDMI, RJ45, Webcam, Wi-Fi, Windows 11 Pro, Black',
      slug: 'lenovo-v-series-v15-business-laptop-156-fhd-display-amd-ryzen-7-7730u-40gb-ram-2tb-ssd-numeric-v2',
      description: 'High-performance business laptop with AMD Ryzen 7 7730U processor, 40GB RAM, 2TB SSD, 15.6" FHD display, and Windows 11 Pro. Perfect for demanding business applications.',
      price: 648,
      originalPrice: 648,
      category: 'electronics',
    ...
    // Product 4 Copy 1 - Lenovo IdeaPad 5X 2-in-1 (Image 2 as primary)
    {
      ...
      productNumber: 4,
      name: 'Lenovo IdeaPad 5X 2-in-1 Copilot+ Extra-Long Battery Life 14" WUXGA FHD+ OLED Touch Display 16GB Memory 512GB Storage Snapdragon X Plus 8-core Processor Windows 11 Home, Pen Included, Luna Gray',
      slug: 'lenovo-ideapad-5x-2-in-1-copilot-extra-long-battery-life-14-wuxga-fhd-oled-touch-display-16gb-copy1',
      description: 'Versatile 2-in-1 laptop with Snapdragon X Plus processor, 16GB RAM, 512GB storage, 14" WUXGA FHD+ OLED touch display, and extra-long battery life. Includes pen and Windows 11 Home.',
      price: 821,
      originalPrice: 821,
      category: 'electronics',
    ...
    // Product 4 Copy 2 - Lenovo IdeaPad 5X 2-in-1 (Image 3 as primary)
    {
      ...
      productNumber: 4,
      name: 'Lenovo IdeaPad 5X 2-in-1 Copilot+ Extra-Long Battery Life 14" WUXGA FHD+ OLED Touch Display 16GB Memory 512GB Storage Snapdragon X Plus 8-core Processor Windows 11 Home, Pen Included, Luna Gray',
      slug: 'lenovo-ideapad-5x-2-in-1-copilot-extra-long-battery-life-14-wuxga-fhd-oled-touch-display-16gb-copy2',
      description: 'Versatile 2-in-1 laptop with Snapdragon X Plus processor, 16GB RAM, 512GB storage, 14" WUXGA FHD+ OLED touch display, and extra-long battery life. Includes pen and Windows 11 Home.',
      price: 821,
      originalPrice: 821,
      category: 'electronics',
    ...
    // Product 5 Copy 1 - Lenovo LOQ 15 Gaming Laptop (Image 2 as primary)
    {
      ...
      productNumber: 5,
      name: 'Lenovo LOQ 15" - NVIDIA GeForce RTX 5050 Graphics - 15.6" IPS LCD FHD 144hz Display - Intel Core i7-13650HX - 24GB DDR5-1 TB SSD - Windows 11 Home - Luna Grey',
      slug: 'lenovo-loq-15-nvidia-geforce-rtx-5050-graphics-156-ips-lcd-fhd-144hz-display-intel-core-i7-v1',
      description: 'Gaming laptop with NVIDIA GeForce RTX 5050 graphics, Intel Core i7-13650HX processor, 24GB DDR5 RAM, 1TB SSD, and 15.6" IPS LCD FHD 144Hz display for smooth gaming.',
      price: 1166,
      originalPrice: 1166,
      category: 'electronics',
    ...
    // Product 5 Copy 2 - Lenovo LOQ 15 Gaming Laptop (Image 3 as primary)
    {
      ...
      productNumber: 5,
      name: 'Lenovo LOQ 15" - NVIDIA GeForce RTX 5050 Graphics - 15.6" IPS LCD FHD 144hz Display - Intel Core i7-13650HX - 24GB DDR5-1 TB SSD - Windows 11 Home - Luna Grey',
      slug: 'lenovo-loq-15-nvidia-geforce-rtx-5050-graphics-156-ips-lcd-fhd-144hz-display-intel-core-i7-v2',
      description: 'Gaming laptop with NVIDIA GeForce RTX 5050 graphics, Intel Core i7-13650HX processor, 24GB DDR5 RAM, 1TB SSD, and 15.6" IPS LCD FHD 144Hz display for smooth gaming.',
      price: 1166,
      originalPrice: 1166,
      category: 'electronics',
    ...
    // Product 6 Copy 1 - LG gram Pro 17-inch (Image 2 as primary)
    {
      ...
      productNumber: 6,
      name: 'LG gram Pro 17-inch Lightweight Laptop Computer, Intel Evo Edition Powered by Intel Core Ultra9 285H Processor, NVIDIA RTX5050, Windows 11 Home, 32GB RAM, 2TB SSD, Black',
      slug: 'lg-gram-pro-17-inch-lightweight-laptop-computer-intel-evo-edition-powered-by-intel-core-ultra9-v1',
      description: 'Ultra-lightweight 17-inch laptop with Intel Core Ultra9 285H processor, NVIDIA RTX5050 graphics, 32GB RAM, 2TB SSD, and Windows 11 Home. Perfect for professionals on the go.',
      price: 2749,
      originalPrice: 2749,
      category: 'electronics',
    ...
    // Product 6 Copy 2 - LG gram Pro 17-inch (Image 3 as primary)
    {
      ...
      productNumber: 6,
      name: 'LG gram Pro 17-inch Lightweight Laptop Computer, Intel Evo Edition Powered by Intel Core Ultra9 285H Processor, NVIDIA RTX5050, Windows 11 Home, 32GB RAM, 2TB SSD, Black',
      slug: 'lg-gram-pro-17-inch-lightweight-laptop-computer-intel-evo-edition-powered-by-intel-core-ultra9-v2',
      description: 'Ultra-lightweight 17-inch laptop with Intel Core Ultra9 285H processor, NVIDIA RTX5050 graphics, 32GB RAM, 2TB SSD, and Windows 11 Home. Perfect for professionals on the go.',
      price: 2749,
      originalPrice: 2749,
      category: 'electronics',
    ...
    // Product 7 Copy 1 - LG gram Pro 16-inch (Image 2 as primary)
    {
      ...
      productNumber: 7,
      name: 'LG gram Pro 16-inch Lightweight Laptop Computer, Intel Evo Edition Powered by Intel Core Ultra7 258V Processor, Copilot+ Windows 11 Home, 32GB RAM, 2TB SSD - Metal Gray',
      slug: 'lg-gram-pro-16-inch-lightweight-laptop-computer-intel-evo-edition-powered-by-intel-core-ultra7-v1',
      description: 'Lightweight 16-inch laptop with Intel Core Ultra7 258V processor, Copilot+ Windows 11 Home, 32GB RAM, 2TB SSD. Features AI-powered productivity and ultra-portable design.',
      price: 1899,
      originalPrice: 1899,
      category: 'electronics',
    ...
    // Product 7 Copy 2 - LG gram Pro 16-inch (Image 3 as primary)
    {
      ...
      productNumber: 7,
      name: 'LG gram Pro 16-inch Lightweight Laptop Computer, Intel Evo Edition Powered by Intel Core Ultra7 258V Processor, Copilot+ Windows 11 Home, 32GB RAM, 2TB SSD - Metal Gray',
      slug: 'lg-gram-pro-16-inch-lightweight-laptop-computer-intel-evo-edition-powered-by-intel-core-ultra7-v2',
      description: 'Lightweight 16-inch laptop with Intel Core Ultra7 258V processor, Copilot+ Windows 11 Home, 32GB RAM, 2TB SSD. Features AI-powered productivity and ultra-portable design.',
      price: 1899,
      originalPrice: 1899,
      category: 'electronics',
    ...
    // Product 8 Copy 1 - Lenovo IdeaPad 5X 2-in-1 Alternative (Image 2 as primary)
    {
      ...
      productNumber: 8,
      name: 'Lenovo IdeaPad 5X 2-in-1 Copilot+ Extra-Long Battery Life 14" WUXGA FHD+ OLED Touch Display 16GB Memory 512GB Storage Snapdragon X Plus 8-core Processor Windows 11 Home, Pen Included, Luna Gray',
      slug: 'lenovo-ideapad-5x-2-in-1-copilot-extra-long-battery-life-14-wuxga-fhd-oled-touch-display-16gb-alt-copy1',
      description: 'Versatile 2-in-1 laptop with Snapdragon X Plus processor, 16GB RAM, 512GB storage, 14" WUXGA FHD+ OLED touch display, and extra-long battery life. Includes pen and Windows 11 Home.',
      price: 32,
      originalPrice: 32,
      category: 'electronics',
    ...
    // Product 8 Copy 2 - Lenovo IdeaPad 5X 2-in-1 Alternative (Image 3 as primary)
    {
      ...
      productNumber: 8,
      name: 'Lenovo IdeaPad 5X 2-in-1 Copilot+ Extra-Long Battery Life 14" WUXGA FHD+ OLED Touch Display 16GB Memory 512GB Storage Snapdragon X Plus 8-core Processor Windows 11 Home, Pen Included, Luna Gray',
      slug: 'lenovo-ideapad-5x-2-in-1-copilot-extra-long-battery-life-14-wuxga-fhd-oled-touch-display-16gb-alt-copy2',
      description: 'Versatile 2-in-1 laptop with Snapdragon X Plus processor, 16GB RAM, 512GB storage, 14" WUXGA FHD+ OLED touch display, and extra-long battery life. Includes pen and Windows 11 Home.',
      price: 32,
      originalPrice: 32,
      category: 'electronics',
    ...
    // Product 9 Copy 1 - Bicycle Pump (Image 2 as primary)
    {
      ...
      productNumber: 9,
      name: 'Bicycle Pump with Gauge, 3X Faster & Auto Stop & Brushless Motor, Electric Bike Tire Pump with Presta and Schrader Valve for Road Bike, MTB, Motorcycle, Ball,etc',
      slug: 'bicycle-pump-with-gauge-3x-faster-auto-stop-brushless-motor-electric-bike-tire-pump-with-presta-v1',
      description: 'Electric bicycle pump with gauge, 3X faster pumping, auto-stop feature, and brushless motor. Compatible with Presta and Schrader valves for bikes, motorcycles, and balls.',
      price: 49,
      originalPrice: 49,
      category: 'sports',
    ...
    // Product 9 Copy 2 - Bicycle Pump (Image 3 as primary)
    {
      ...
      productNumber: 9,
      name: 'Bicycle Pump with Gauge, 3X Faster & Auto Stop & Brushless Motor, Electric Bike Tire Pump with Presta and Schrader Valve for Road Bike, MTB, Motorcycle, Ball,etc',
      slug: 'bicycle-pump-with-gauge-3x-faster-auto-stop-brushless-motor-electric-bike-tire-pump-with-presta-v2',
      description: 'Electric bicycle pump with gauge, 3X faster pumping, auto-stop feature, and brushless motor. Compatible with Presta and Schrader valves for bikes, motorcycles, and balls.',
      price: 49,
      originalPrice: 49,
      category: 'sports',
    ...
    // Product 10 Copy 1 - VOCH GALA Nipple Covers (Image 2 as primary)
    {
      ...
      productNumber: 10,
      name: 'VOCH GALA Nipple Covers 2 Pairs-Seamless and Sheer Adhesive Silicone Nipple Pasties for Women Reusable, Sticky Breast Petals',
      slug: 'voch-gala-nipple-covers-2-pairs-seamless-and-sheer-adhesive-silicone-nipple-pasties-for-women-v1',
      description: 'Seamless and sheer adhesive silicone nipple covers for women. Reusable and sticky breast petals that provide comfort and coverage.',
      price: 18.26,
      originalPrice: 18.26,
      category: 'fashion',
    ...
    // Product 10 Copy 2 - VOCH GALA Nipple Covers (Image 3 as primary)
    {
      ...
      productNumber: 10,
      name: 'VOCH GALA Nipple Covers 2 Pairs-Seamless and Sheer Adhesive Silicone Nipple Pasties for Women Reusable, Sticky Breast Petals',
      slug: 'voch-gala-nipple-covers-2-pairs-seamless-and-sheer-adhesive-silicone-nipple-pasties-for-women-v2',
      description: 'Seamless and sheer adhesive silicone nipple covers for women. Reusable and sticky breast petals that provide comfort and coverage.',
      price: 18.26,
      originalPrice: 18.26,
      category: 'fashion',
    ...
    // Product 11 Copy 1 - Popular Girls Padded Training Bra (Image 2 as primary)
    {
      ...
      productNumber: 11,
      name: 'Popular Girls Padded Training Bra Pack – Crop Cami Training Bras for Girls. Seamless Bra Design with Removable Padding',
      slug: 'popular-girls-padded-training-bra-pack-crop-cami-training-bras-for-girls-seamless-bra-design-v1',
      description: 'Training bra pack for girls with seamless design and removable padding. Crop cami style training bras perfect for young girls.',
      price: 26.99,
      originalPrice: 26.99,
      category: 'fashion',
    ...
    // Product 11 Copy 2 - Popular Girls Padded Training Bra (Image 3 as primary)
    {
      ...
      productNumber: 11,
      name: 'Popular Girls Padded Training Bra Pack – Crop Cami Training Bras for Girls. Seamless Bra Design with Removable Padding',
      slug: 'popular-girls-padded-training-bra-pack-crop-cami-training-bras-for-girls-seamless-bra-design-v2',
      description: 'Training bra pack for girls with seamless design and removable padding. Crop cami style training bras perfect for young girls.',
      price: 26.99,
      originalPrice: 26.99,
      category: 'fashion',
    ...
    // Product 12 Copy 1 - Popular Cotton Girls Training Bra (Image 2 as primary)
    {
      ...
      productNumber: 12,
      name: 'Popular Cotton Girls Training Bra - Crop Cami Training Bras for Girls with Adjustable Straps. Cotton Bra Pack.',
      slug: 'popular-cotton-girls-training-bra-crop-cami-training-bras-for-girls-with-adjustable-straps-bra-copy1',
      description: 'Cotton training bra for girls with adjustable straps. Crop cami style training bras made from comfortable cotton material.',
      price: 16.99,
      originalPrice: 16.99,
      category: 'fashion',
    ...
    // Product 12 Copy 2 - Popular Cotton Girls Training Bra (Image 3 as primary)
    {
      ...
      productNumber: 12,
      name: 'Popular Cotton Girls Training Bra - Crop Cami Training Bras for Girls with Adjustable Straps. Cotton Bra Pack.',
      slug: 'popular-cotton-girls-training-bra-crop-cami-training-bras-for-girls-with-adjustable-straps-bra-copy2',
      description: 'Cotton training bra for girls with adjustable straps. Crop cami style training bras made from comfortable cotton material.',
      price: 16.99,
      originalPrice: 16.99,
      category: 'fashion',
    ...
    // Product 13 Copy 1 - Hilarious Jokes For 8 Year Old Kids (Image 2 as primary)
    {
      ...
      productNumber: 13,
      name: 'Hilarious Jokes For 8 Year Old Kids: An Awesome LOL Gag Book For Young Boys and Girls Filled With Tons of Tongue Twisters, Rib Ticklers, Side Splitters, and Knock Knocks',
      slug: 'hilarious-jokes-for-8-year-old-kids-an-awesome-lol-gag-book-for-young-boys-and-girls-filled-with-v1',
      description: 'Fun joke book for 8-year-old kids filled with hilarious jokes, tongue twisters, rib ticklers, side splitters, and knock-knock jokes. Perfect for young boys and girls.',
      price: 9.99,
      originalPrice: 9.99,
      category: 'books',
    ...
    // Product 13 Copy 2 - Hilarious Jokes For 8 Year Old Kids (Image 3 as primary)
    {
      ...
      productNumber: 13,
      name: 'Hilarious Jokes For 8 Year Old Kids: An Awesome LOL Gag Book For Young Boys and Girls Filled With Tons of Tongue Twisters, Rib Ticklers, Side Splitters, and Knock Knocks',
      slug: 'hilarious-jokes-for-8-year-old-kids-an-awesome-lol-gag-book-for-young-boys-and-girls-filled-with-v2',
      description: 'Fun joke book for 8-year-old kids filled with hilarious jokes, tongue twisters, rib ticklers, side splitters, and knock-knock jokes. Perfect for young boys and girls.',
      price: 9.99,
      originalPrice: 9.99,
      category: 'books',
    ...
    // Product 15 Copy 1 - Popular Cotton Girls Training Bra Alternative (Image 2 as primary)
    {
      ...
      productNumber: 15,
      name: 'Popular Cotton Girls Training Bra - Crop Cami Training Bras for Girls with Adjustable Straps. Cotton Bra Pack.',
      slug: 'popular-cotton-girls-training-bra-crop-cami-training-bras-for-girls-with-adjustable-straps-copy1',
      description: 'Cotton training bra for girls with adjustable straps. Crop cami style training bras made from comfortable cotton material.',
      price: 16.98,
      originalPrice: 16.98,
      category: 'fashion',
    ...
    // Product 15 Copy 2 - Popular Cotton Girls Training Bra Alternative (Image 3 as primary)
    {
      ...
      productNumber: 15,
      name: 'Popular Cotton Girls Training Bra - Crop Cami Training Bras for Girls with Adjustable Straps. Cotton Bra Pack.',
      slug: 'popular-cotton-girls-training-bra-crop-cami-training-bras-for-girls-with-adjustable-straps-copy2',
      description: 'Cotton training bra for girls with adjustable straps. Crop cami style training bras made from comfortable cotton material.',
      price: 16.98,
      originalPrice: 16.98,
      category: 'fashion',
    ...
    // Product 16 Copy 1 - Popular Womens Bike Shorts (Image 2 as primary)
    {
      ...
      productNumber: 16,
      name: 'Popular Womens Bike Shorts Plus Size - Cotton Biker Bottoms. Bermuda Long Shorts for Women. Great Gym, Workout & Yoga',
      slug: 'popular-womens-bike-shorts-plus-size-cotton-biker-bottoms-bermuda-long-shorts-for-women-great-v1',
      description: 'Plus size bike shorts for women made from cotton. Bermuda long shorts perfect for gym, workout, and yoga activities.',
      price: 14.99,
      originalPrice: 14.99,
      category: 'fashion',
    ...
    // Product 16 Copy 2 - Popular Womens Bike Shorts (Image 3 as primary)
    {
      ...
      productNumber: 16,
      name: 'Popular Womens Bike Shorts Plus Size - Cotton Biker Bottoms. Bermuda Long Shorts for Women. Great Gym, Workout & Yoga',
      slug: 'popular-womens-bike-shorts-plus-size-cotton-biker-bottoms-bermuda-long-shorts-for-women-great-v2',
      description: 'Plus size bike shorts for women made from cotton. Bermuda long shorts perfect for gym, workout, and yoga activities.',
      price: 14.99,
      originalPrice: 14.99,
      category: 'fashion',
    ...
    // Product 17 Copy 1 - Mouse Jiggler Mover (Image 2 as primary)
    {
      ...
      productNumber: 17,
      name: 'Mouse Jiggler Mover Wiggler Undetectable Shaker USB Port for Computer Laptop, Keeps PC Awake, Simulate Movement to Prevent Laptop Entering Sleep, No Software Plug-and-Play',
      slug: 'mouse-jiggler-mover-wiggler-undetectable-shaker-usb-port-for-computer-laptop-keeps-pc-awake-v1',
      description: 'USB mouse jiggler that keeps your computer awake by simulating mouse movement. Undetectable shaker prevents laptop from entering sleep mode. No software required, plug-and-play.',
      price: 6.99,
      originalPrice: 6.99,
      category: 'electronics',
    ...
    // Product 17 Copy 2 - Mouse Jiggler Mover (Image 3 as primary)
    {
      ...
      productNumber: 17,
      name: 'Mouse Jiggler Mover Wiggler Undetectable Shaker USB Port for Computer Laptop, Keeps PC Awake, Simulate Movement to Prevent Laptop Entering Sleep, No Software Plug-and-Play',
      slug: 'mouse-jiggler-mover-wiggler-undetectable-shaker-usb-port-for-computer-laptop-keeps-pc-awake-v2',
      description: 'USB mouse jiggler that keeps your computer awake by simulating mouse movement. Undetectable shaker prevents laptop from entering sleep mode. No software required, plug-and-play.',
      price: 6.99,
      originalPrice: 6.99,
      category: 'electronics',
    ...
    // Product 18 Copy 1 - LISEN Retractable Car Charger (Image 2 as primary)
    {
      ...
      productNumber: 18,
      name: 'LISEN Retractable Car Charger, 69W Cars Adapter USB C Fast Charger, Car Accessories for Women Men, Christmas for Gifts for Dad Mom, Gifts for Women Men, for iPhone 17 Pro Max Air 16 15 14 13 Plus',
      slug: 'lisen-retractable-car-charger-69w-cars-adapter-usb-c-fast-charger-car-accessories-for-women-men-v1',
      description: '69W retractable car charger with USB-C fast charging. Compatible with iPhone 17 Pro Max, Air, 16, 15, 14, 13 Plus. Perfect gift for men and women.',
      price: 16.99,
      originalPrice: 29.99,
      category: 'electronics',
    ...
    // Product 18 Copy 2 - LISEN Retractable Car Charger (Image 3 as primary)
    {
      ...
      productNumber: 18,
      name: 'LISEN Retractable Car Charger, 69W Cars Adapter USB C Fast Charger, Car Accessories for Women Men, Christmas for Gifts for Dad Mom, Gifts for Women Men, for iPhone 17 Pro Max Air 16 15 14 13 Plus',
      slug: 'lisen-retractable-car-charger-69w-cars-adapter-usb-c-fast-charger-car-accessories-for-women-men-v2',
      description: '69W retractable car charger with USB-C fast charging. Compatible with iPhone 17 Pro Max, Air, 16, 15, 14, 13 Plus. Perfect gift for men and women.',
      price: 16.99,
      originalPrice: 29.99,
      category: 'electronics',
    ...
    // Product 24 Copy 1 - 16 inch Screen Magnifier (Image 2 as primary)
    {
      ...
      productNumber: 24,
      name: '16 inch Screen Magnifier for Cell Phone 3D Magnifier Screen Enlarger for Movies,Videos,Reading,Gaming-Screen Amplifie with Foldable Phone Stand Holder. Compatible with All Smartphones-White',
      slug: '16-inch-screen-magnifier-for-cell-phone-3d-magnifier-screen-enlarger-for-moviesvideosreadinggamin-v1',
      description: '16-inch screen magnifier for cell phones with 3D magnifier screen enlarger. Perfect for movies, videos, reading, and gaming. Includes foldable phone stand holder, compatible with all smartphones.',
      price: 23.20,
      originalPrice: 23.20,
      category: 'electronics',
    ...
    // Product 24 Copy 2 - 16 inch Screen Magnifier (Image 3 as primary)
    {
      ...
      productNumber: 24,
      name: '16 inch Screen Magnifier for Cell Phone 3D Magnifier Screen Enlarger for Movies,Videos,Reading,Gaming-Screen Amplifie with Foldable Phone Stand Holder. Compatible with All Smartphones-White',
      slug: '16-inch-screen-magnifier-for-cell-phone-3d-magnifier-screen-enlarger-for-moviesvideosreadinggamin-v2',
      description: '16-inch screen magnifier for cell phones with 3D magnifier screen enlarger. Perfect for movies, videos, reading, and gaming. Includes foldable phone stand holder, compatible with all smartphones.',
      price: 23.20,
      originalPrice: 23.20,
      category: 'electronics',
    ...
    // Product 25 Copy 1 - Bitzee Interactive Toy (Image 2 as primary)
    {
      ...
      productNumber: 25,
      name: 'Bitzee, Interactive Toy Digital Pet with 15 Animals Inside, Virtual Electronic Pets React to Touch, Kids Toys for Girls and Boys',
      slug: 'bitzee-interactive-toy-digital-pet-with-15-animals-inside-virtual-electronic-pets-react-to-touch-v1',
      description: 'Interactive digital pet toy with 15 different animals inside. Virtual electronic pets that react to touch. Perfect toy for girls and boys.',
      price: 36.99,
      originalPrice: 36.99,
      category: 'toys',
    ...
    // Product 25 Copy 2 - Bitzee Interactive Toy (Image 3 as primary)
    {
      ...
      productNumber: 25,
      name: 'Bitzee, Interactive Toy Digital Pet with 15 Animals Inside, Virtual Electronic Pets React to Touch, Kids Toys for Girls and Boys',
      slug: 'bitzee-interactive-toy-digital-pet-with-15-animals-inside-virtual-electronic-pets-react-to-touch-v2',
      description: 'Interactive digital pet toy with 15 different animals inside. Virtual electronic pets that react to touch. Perfect toy for girls and boys.',
      price: 36.99,
      originalPrice: 36.99,
      category: 'toys',
    ...
    // Product 26 Copy 1 - JBL Clip 4 Bluetooth Speaker (Image 2 as primary)
    {
      ...
      productNumber: 26,
      name: 'JBL Clip 4 - Portable Mini Bluetooth Speaker, big audio and punchy bass, integrated carabiner, IP67 waterproof and dustproof, 10 hours of playtime, speaker for home, outdoor and travel (Black)',
      slug: 'jbl-clip-4-portable-mini-bluetooth-speaker-big-audio-and-punchy-bass-integrated-carabiner-ip67-v1',
      description: 'Portable mini Bluetooth speaker with big audio and punchy bass. Features integrated carabiner, IP67 waterproof and dustproof rating, 10 hours of playtime. Perfect for home, outdoor, and travel.',
      price: 46.95,
      originalPrice: 46.95,
      category: 'electronics',
    ...
    // Product 26 Copy 2 - JBL Clip 4 Bluetooth Speaker (Image 3 as primary)
    {
      ...
      productNumber: 26,
      name: 'JBL Clip 4 - Portable Mini Bluetooth Speaker, big audio and punchy bass, integrated carabiner, IP67 waterproof and dustproof, 10 hours of playtime, speaker for home, outdoor and travel (Black)',
      slug: 'jbl-clip-4-portable-mini-bluetooth-speaker-big-audio-and-punchy-bass-integrated-carabiner-ip67-v2',
      description: 'Portable mini Bluetooth speaker with big audio and punchy bass. Features integrated carabiner, IP67 waterproof and dustproof rating, 10 hours of playtime. Perfect for home, outdoor, and travel.',
      price: 46.95,
      originalPrice: 46.95,
      category: 'electronics',
    ...
    // Product 27 Copy 1 - Samsung Galaxy Watch Ultra (Image 2 as primary)
    {
      ...
      productNumber: 27,
      name: 'Samsung Galaxy Watch Ultra (2024) 47mm LTE AI Smartwatch w/Energy Score, Wellness Tips, Heart Rate Tracking, Sleep Monitor, Fitness Tracker, GPS,Titanium Silver [US Version, 1Yr Manufacturer Warranty]',
      slug: 'samsung-galaxy-watch-ultra-2024-47mm-lte-ai-smartwatch-wenergy-score-wellness-tips-heart-rate-v1',
      description: 'Samsung Galaxy Watch Ultra 47mm LTE AI smartwatch with energy score, wellness tips, heart rate tracking, sleep monitoring, fitness tracking, and GPS. Titanium silver with 1-year manufacturer warranty.',
      price: 449,
      originalPrice: 449,
      category: 'electronics',
    ...
    // Product 27 Copy 2 - Samsung Galaxy Watch Ultra (Image 3 as primary)
    {
      ...
      productNumber: 27,
      name: 'Samsung Galaxy Watch Ultra (2024) 47mm LTE AI Smartwatch w/Energy Score, Wellness Tips, Heart Rate Tracking, Sleep Monitor, Fitness Tracker, GPS,Titanium Silver [US Version, 1Yr Manufacturer Warranty]',
      slug: 'samsung-galaxy-watch-ultra-2024-47mm-lte-ai-smartwatch-wenergy-score-wellness-tips-heart-rate-v2',
      description: 'Samsung Galaxy Watch Ultra 47mm LTE AI smartwatch with energy score, wellness tips, heart rate tracking, sleep monitoring, fitness tracking, and GPS. Titanium silver with 1-year manufacturer warranty.',
      price: 449,
      originalPrice: 449,
      category: 'electronics',
    ...
    // Product 3 Copy 1 - Cordless Robotic Pool Cleaner (Image 2 as primary)
    {
      ...
      productNumber: 3,
      name: 'Cordless Robotic Pool Cleaner – 150 Mins Runtime, IPX8 Waterproof, 2200 Sq Ft Coverage, Powerful Automatic Pool Vacuum Robot for In-Ground & Above-Ground Pools, Quick Charging, Dual Brushes',
      slug: 'cordless-robotic-pool-cleaner-150-mins-runtime-ipx8-waterproof-2200-sq-ft-coverage-powerful-v1',
      description: 'Advanced cordless robotic pool cleaner with 150 minutes runtime and IPX8 waterproof rating for complete pool maintenance.',
      price: 0,
      originalPrice: 0,
      category: 'home',
    ...
    // Product 3 Copy 2 - Cordless Robotic Pool Cleaner (Image 3 as primary)
    {
      ...
      productNumber: 3,
      name: 'Cordless Robotic Pool Cleaner – 150 Mins Runtime, IPX8 Waterproof, 2200 Sq Ft Coverage, Powerful Automatic Pool Vacuum Robot for In-Ground & Above-Ground Pools, Quick Charging, Dual Brushes',
      slug: 'cordless-robotic-pool-cleaner-150-mins-runtime-ipx8-waterproof-2200-sq-ft-coverage-powerful-v2',
      description: 'Advanced cordless robotic pool cleaner with 150 minutes runtime and IPX8 waterproof rating for complete pool maintenance.',
      price: 0,
      originalPrice: 0,
      category: 'home',
    ...
    // Product 4 Copy 1 - WYBOT C2 Vision Cordless Pool Cleaner (Image 2 as primary)
    {
      ...
      productNumber: 4,
      name: 'WYBOT C2 Vision Cordless Pool Cleaner with Camera, 8-in-1 Pool Vacuum for Inground Pools, Powerful Suction, Ultra-Fine Filter System Pool Robot, Wall Climbing Navigation, Gray',
      slug: 'wybot-c2-vision-cordless-pool-cleaner-with-camera-8-in-1-pool-vacuum-for-inground-pools-powerful-v1',
      description: 'Advanced pool cleaner with camera technology, 8-in-1 functionality, and wall climbing navigation for complete pool cleaning.',
      price: 0,
      originalPrice: 0,
      category: 'home',
    ...
    // Product 4 Copy 2 - WYBOT C2 Vision Cordless Pool Cleaner (Image 3 as primary)
    {
      ...
      productNumber: 4,
      name: 'WYBOT C2 Vision Cordless Pool Cleaner with Camera, 8-in-1 Pool Vacuum for Inground Pools, Powerful Suction, Ultra-Fine Filter System Pool Robot, Wall Climbing Navigation, Gray',
      slug: 'wybot-c2-vision-cordless-pool-cleaner-with-camera-8-in-1-pool-vacuum-for-inground-pools-powerful-v2',
      description: 'Advanced pool cleaner with camera technology, 8-in-1 functionality, and wall climbing navigation for complete pool cleaning.',
      price: 0,
      originalPrice: 0,
      category: 'home',
    ...
    // Product 29 - boeemi Frog Toilet Bolt Covers Decorative Glow in The Dark
    {
      ...
      slug: 'boeemi-frog-toilet-bolt-covers-decorative-glow-in-the-dark-2pcs-toilet-screw-caps-luminous-green-pla',
    ...
    // Product 30 - YRU True Military-Grade Car Phone Holder
    {
      ...
      slug: 'yru-true-military-grade-360-rotation-suction-2025-ultimate-car-phone-holder-mount-90lbs-safest-stron',
    ...
    // Product 30 Copy 1 - YRU True Military-Grade Car Phone Holder (Image 2 as primary)
    {
      ...
      productNumber: 30,
      name: 'YRU True Military-Grade [360° Rotation Suction] 2025 Ultimate Car Phone Holder Mount 【90+LBS Safest Strongest & Patent Certs】 Dashboard Windshield Vent for iPhone 17 16 Pro Max Samsung, Gloss Black',
      slug: 'yru-true-military-grade-360-rotation-suction-2025-ultimate-car-phone-holder-mount-90lbs-safest-v1',
      description: 'Military-grade car phone holder with 360° rotation, 90+ lbs suction strength, and patent certifications. Compatible with iPhone 17, 16, Pro Max, Samsung and other smartphones.',
      price: 25.97,
      originalPrice: 25.97,
      category: 'automotive',
    ...
    // Product 30 Copy 2 - YRU True Military-Grade Car Phone Holder (Image 3 as primary)
    {
      ...
      productNumber: 30,
      name: 'YRU True Military-Grade [360° Rotation Suction] 2025 Ultimate Car Phone Holder Mount 【90+LBS Safest Strongest & Patent Certs】 Dashboard Windshield Vent for iPhone 17 16 Pro Max Samsung, Gloss Black',
      slug: 'yru-true-military-grade-360-rotation-suction-2025-ultimate-car-phone-holder-mount-90lbs-safest-v2',
      description: 'Military-grade car phone holder with 360° rotation, 90+ lbs suction strength, and patent certifications. Compatible with iPhone 17, 16, Pro Max, Samsung and other smartphones.',
      price: 25.97,
      originalPrice: 25.97,
      category: 'automotive',
