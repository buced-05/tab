...
const CybersecurityArticleDetail = () => {
  ...
  useEffect(() => {
    const foundArticle = getAIArticleById(articleId);
    if (foundArticle) {
  ...
  const generateDOI = (article) => {
    ...
    return `10.1000/alladsmarket.cybersec.${year}.${id}`;
  };
  ...
  const generateCitation = (format = 'apa') => {
    ...
    switch (format) {
      case 'apa':
        return `${author.name}. (${currentYear}). ${article.title}. <em>AllAdsMarket Cybersecurity Journal</em>, ${metadata.volume}(${metadata.issue}), ${metadata.pages}. https://doi.org/${metadata.doi}`;
      
      case 'mla':
        return `${author.name}. "${article.title}." <em>AllAdsMarket Cybersecurity Journal</em>, vol. ${metadata.volume}, no. ${metadata.issue}, ${currentYear}, pp. ${metadata.pages}.`;
      
      case 'chicago':
        return `${author.name}. "${article.title}." <em>AllAdsMarket Cybersecurity Journal</em> ${metadata.volume}, no. ${metadata.issue} (${currentYear}): ${metadata.pages}.`;
      
      default:
        return `${author.name}. (${currentYear}). ${article.title}. AllAdsMarket Cybersecurity Journal.`;
    }
  };
...
<body>
    ...
    a.href = url;
    a.download = `${article.title.replace(/[^a-zA-Z0-9]/g, '_')}_cybersecurite.html`;
...
Je vous partage cet article intéressant sur la cybersécurité :
            ...
            <aside className="article-sidebar">
              <div className="sidebar-section">
                ...
                <nav className="article-nav">
                  ...
                  <a href="#ia-cybersecurite" className="nav-link">IA & Cybersécurité</a>
                  <a href="#quantique" className="nav-link">Informatique Quantique</a>
                  <a href="#technologies" className="nav-link">Technologies Émergentes</a>
                  <a href="#defis" className="nav-link">Défis 2025</a>
                ...
                <div className="article-hero-image">
                  ...
                  <div className="hero-overlay">
                    <div className="hero-badges">
                      ...
                      <span className="cybersecurity-badge">Cybersécurité</span>
                    </div>
                  </div>
                </div>
...
export default CybersecurityArticleDetail;
